...
module.exports = class CouchDbObject{
    constructor(params){
      this.params = params;
    ...
    async send({headers, renderPipe}){
      ...
      return this.toObject(headers, renderPipe)
        .then((obj) => {
          return promisifyRequest({method:"post", url:`${protocol}://${username}:${password}@${hostName}/${dbName}`, json:{_id:this.params._id, data:obj}});
        });
    }
  }
